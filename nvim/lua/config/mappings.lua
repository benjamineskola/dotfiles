...
map("n", "<leader>c", function() require("config.telescope").projects() end, { noremap = true })
map("n", "<leader>y", function() require("config.telescope").yaml_symbols() end, { noremap = true })
