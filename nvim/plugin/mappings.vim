...
nnoremap <leader>c <cmd>lua require('telescope.builtin').find_files({find_command={"sh", "-c", "fd --type d --max-depth 1 . $HOME/Code $HOME/Code/Work $HOME/Code/Personal; echo $XDG_CONFIG_HOME"}})<cr>
